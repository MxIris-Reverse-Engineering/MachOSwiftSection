...
See [KNOWN_ISSUES.md](https://github.com/MxIris-Reverse-Engineering/MachOSwiftSection/blob/0.9.0/KNOWN_ISSUES.md) for two non-blocking concurrency edge cases observed only under parallel test harness configurations.
