...
- **文档**：[Evolutions/0008](../Evolutions/0008-type-indexing-revival.md)、[TypeIndexingPipeline.md](TypeIndexingPipeline.md)（含与提案的差异：swift-dependencies 未引入、兜底解析器未编写；identifier 重写一节）、[TaskReports/2026-08-22-type-indexing-revival.md](TaskReports/2026-08-22-type-indexing-revival.md)、AGENTS.md 架构节新增 TypeIndexing 条目。
