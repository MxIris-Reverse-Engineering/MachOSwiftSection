...
public final class SwiftIndexEventReporter: SwiftIndexEvents.Handler, Sendable {
    ...
    private func formatTypeIndexingDetail(_ result: SwiftIndexEvents.TypeIndexingResult) -> String {
        var parts: [String] = []
