    ...
    @Test func types() throws {
        ...
        for typeContextDescriptor in typeContextDescriptors {
            ...
            case .enum:
                ...
                try print(enumType.dump(using: .default, in: machOImage))
            case .struct:
                ...
                try print(structType.dump(using: .default, in: machOImage))
            case .class:
                ...
                try print(classType.dump(using: .default, in: machOImage))
            default:
                break
            }
        }
