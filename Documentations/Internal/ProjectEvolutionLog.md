...
- **关联文档**：[draft-builtin-borrow-support](../Evolutions/draft-builtin-borrow-support.md)、[draft-raw-layout-artificial-field-handling](../Evolutions/draft-raw-layout-artificial-field-handling.md)、[Modules/SwiftLayout.md](Modules/SwiftLayout.md)。
- **对应版本**：随下一次发布。
