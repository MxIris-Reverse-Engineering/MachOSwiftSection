...
extension SwiftEvolutionInterfaceDumpTests {
    ...
    private func preparedBuilder<MachO: MachOFieldLayoutRenderable>(
    ...
    func evolutionInterfaceString<MachO: MachOFieldLayoutRenderable>(versions: [(label: String, machO: MachO)]) async throws {
    ...
    func evolutionInterfaceFile<MachO: MachOFieldLayoutRenderable>(versions: [(label: String, machO: MachO)]) async throws {
        let builder = try await preparedBuilder(versions: versions)
