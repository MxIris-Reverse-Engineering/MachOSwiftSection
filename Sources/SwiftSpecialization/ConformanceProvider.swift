...
/// ConformanceProvider implementation backed by SwiftDeclarationIndexer.
///
/// **Preparation contract.** The wrapped `SwiftDeclarationIndexer` must have
...
/// `SwiftDeclarationIndexer`, which is also SPI. Use the factory initializer
...
public final class IndexerConformanceProvider<MachO: MachOSwiftSectionRepresentableWithCache>: @unchecked Sendable {
    private let indexer: SwiftDeclarationIndexer<MachO>
