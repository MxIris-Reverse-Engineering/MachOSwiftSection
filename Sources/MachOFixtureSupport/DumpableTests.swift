...
extension DumpableTests {
    ...
    package func dumpProtocols<MachO: MachOFieldLayoutRenderable>(for machO: MachO) async throws {
    ...
    package func dumpProtocolConformances<MachO: MachOFieldLayoutRenderable>(for machO: MachO) async throws {
    ...
    package func dumpTypes<MachO: MachOFieldLayoutRenderable>(for machO: MachO, isDetail: Bool = true, options: DumpableTypeOptions = [.enum, .struct, .class], using configuration: DumperConfiguration? = nil) async throws {
    ...
    package func dumpOpaqueTypes<MachO: MachOFieldLayoutRenderable>(for machO: MachO) async throws {
    ...
    package func dumpAssociatedTypes<MachO: MachOFieldLayoutRenderable>(for machO: MachO) async throws {
    ...
    package func dumpBuiltinTypes<MachO: MachOFieldLayoutRenderable>(for machO: MachO) async throws {
