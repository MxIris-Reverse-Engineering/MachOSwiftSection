...
/// for ObjC interop with `dispatch_*` types). It's not a Swift class
/// metadata in the usual sense — it just describes the dispatch
/// runtime's class shape — and there is no static record reachable
/// from the SymbolTestsCore section walks. The Suite asserts the
...
package enum DispatchClassMetadataBaselineGenerator {
    package static func generate(outputDirectory: URL) throws {
        ...
        // asserts structural members behave against a synthetic
        // memberwise instance.
        //
        // `init(layout:offset:)` is filtered as memberwise-synthesized.
        """
