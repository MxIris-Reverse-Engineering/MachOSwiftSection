...
extension RelativeDirectPointerProtocol {
    ...
    func resolveDirect(from offset: Int, in machO: some MachORepresentableWithCache & Readable) throws -> Pointee {
    ...
    func resolveDirectAny<T: Resolvable>(from offset: Int, in machO: some MachORepresentableWithCache & Readable) throws -> T {
