...
struct RenderingVerificationTests {
    ...
    private func renderInterface(in machO: some MachOFieldLayoutRenderable, options: Set<String>) async throws -> String {
    ...
    private func renderDump(in machO: some MachOFieldLayoutRenderable, options: Set<String>) async throws -> String {
