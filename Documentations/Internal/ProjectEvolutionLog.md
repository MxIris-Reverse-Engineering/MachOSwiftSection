...
- **文档**：[TaskReports/2026-08-14-pr103-review-round-three-fixes.md](TaskReports/2026-08-14-pr103-review-round-three-fixes.md)。批次 3（清理与裁决台账，含推翻 `NodeStoreMigrationOpenIssues.md` 2026-08-03 对公开字典键类型的「不修」裁决）随后补记本节。
- **对应版本**：`0.15.1` 之后、下一次 bump 之前（`feature/node-store-migration` 分支）。
