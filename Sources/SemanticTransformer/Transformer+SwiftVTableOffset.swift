...
extension Transformer {
    ...
    public struct SwiftVTableOffset: Module {
        ...
        public init(from decoder: any Decoder) throws {
            ...
            self.labeledTemplate = try container.decodeIfPresent(String.self, forKey: .labeledTemplate) ?? Templates.standardLabeled
        ...
        /// Checks if either template contains a specific token.
