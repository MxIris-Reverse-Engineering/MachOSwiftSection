...
public enum OpaqueReturnTypes {
    public struct OpaqueReturnTypeTest {
        /// Proposal-0006 witnesses. The three protocols share one associated
        ...
        /// Proposal 0006, name-fallback guard: `UnpinnedElementProtocol`
        ...
        /// Proposal 0006, same-module refine closure: the constraint anchors
        ...
        /// Proposal 0006, cross-image refine closure: the refine fact lives in
